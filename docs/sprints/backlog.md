...
| 2 | [sprint-2.md](sprint-2.md) | Dashboard + Programme + Workout actif (6 phases) + Nutrition + Affiliés + Banners | 26 tickets (22 done via 22 PRs/issues mergées, 4 todo sans issue GitHub : T14, T20, T24, T25) | En cours |
...
**Total :** 80 tickets (dont 22 déjà mergés via 22 PRs/issues Sprint 2). Reste à livrer : 58 tickets (4 Sprint 2 + 26 Sprint 3 + 20 Sprint 4 + 8 Sprint 5) — cible : < 6 semaines en routine continue 2 PR/jour.
