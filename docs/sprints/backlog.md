...
| 2 | [sprint-2.md](sprint-2.md) | Dashboard + Programme + Workout actif + Nutrition + Affiliés + Banners | 14 tickets | À planifier |
...
**Total :** 53 tickets fragmentés sur 4 sprints (~32 jours-homme dans la spec v2, -2j Reader supprimé + 1j tutoriel + 1j attribution = ~32j — cible : < 6 semaines en routine continue 2 PR/jour).
